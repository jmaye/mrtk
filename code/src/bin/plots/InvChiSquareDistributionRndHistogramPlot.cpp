...
/** \file InvChiSquareDistributionRndHistogramPlot.cpp
    \brief This file is a testing binary for plotting random samples of the
           InvChiSquareDistribution class
  */
...
int main(int argc, char** argv) {
  ...
  InvChiSquareDistribution dist(5);
  ...
  hist.normalize();
  HistogramPlot<double, 1> plot("ChiSquareDistributionRndHistogramPlot", hist);
  plot.show();
  return app.exec();
}
