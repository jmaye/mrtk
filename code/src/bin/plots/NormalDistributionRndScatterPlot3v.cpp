...
int main(int argc, char** argv) {
  ...
  NormalDistribution<3> dist;
  dist.getSamples(data, 100000);
  ScatterPlot<3> plot("NormalDistributionRndScatterPlot3v", data);
  plot.show();
  return app.exec();
}
