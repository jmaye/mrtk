...
/** \file LinearRegressionPredMv.h
    \brief This file defines the LinearRegressionPredMv class, which represents
           a predictive multivariate linear regression
  */

#ifndef LINEARREGRESSIONPREDMV_H
#define LINEARREGRESSIONPREDMV_H

#include "statistics/StudentDistribution.h"
#include "base/Serializable.h"
#include "exceptions/BadArgumentException.h"

/** The LinearRegressionPredMv class represents a multivariate predictive linear
    regression.
...
public:
  ...
  LinearRegressionPred(const Eigen::Matrix<double, M, 1>& coefficients =
    Eigen::Matrix<double, M, 1>::Ones(), const Eigen::Matrix<double, M, M>&
    coeffCovariance = Eigen::Matrix<double, M, M>::Identity(), const
    Eigen::Matrix<double, M - 1, 1>& basis =
    Eigen::Matrix<double, M - 1, 1>::Zero(), double regressionVariance = 1.0);
  /// Copy constructor
...
#include "statistics/LinearRegressionPredMv.tpp"

#endif // LINEARREGRESSIONPREDMV_H
