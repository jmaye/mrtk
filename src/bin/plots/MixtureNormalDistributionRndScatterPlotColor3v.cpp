...
/** \file MixtureNormalDistributionRndScatterPlotColor3v.cpp
    \brief This file is a testing binary for plotting random samples of a 
           a mixture of trivariate normal distributions with colored points
  */
...
int main(int argc, char** argv) {
  ...
  std::vector<std::tuple<Eigen::Matrix<double, 3, 1>, size_t> > data;
